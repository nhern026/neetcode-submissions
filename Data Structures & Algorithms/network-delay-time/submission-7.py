# Session 2, attempt 1: 
# look at how i didn't inflate the heap below. 
# i only added to it if it improved
    ...
    def networkDelayTime(self, times: List[List[int]], n: int, k: int) -> int:
        ...
        while min_time_heap:
            ...
            for dst, ti in node2edges[curr]:
                if trail_time + ti < node2time[dst]: # only update or push if its an improvement, this helps keep queue from inflating
                    node2time[dst] = trail_time + ti
